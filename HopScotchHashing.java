//===========================================================================================================================
//	Program : To perform Hop Scotch Hashing
//===========================================================================================================================
...
public class HopScotchHashing<T> {
    ...
    void resize() {
    	if(overflow.size()>=Math.log(maxSize)){
			...
			HopScotchHashing<T> n=new HopScotchHashing((n1+n2)*4);
	...
	public static void main(String[] args)  {
		HopScotchHashing<Integer> t=new HopScotchHashing<>();
